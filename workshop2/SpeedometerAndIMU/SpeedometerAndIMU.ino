...
// compute vehicle turning rate [rads/s]
double compute_turning_rate(double v_L, double v_R)
{
    double omega;
...
void loop()
{
    ...
    if (t_now - t_last >= T)
    {
        ...
        omega = compute_turning_rate(v_L, v_R);
