...
float omega_x_bias = -0.37, omega_y_bias = 0.06, omega_z_bias = -0.06;
float omegaprint_x, omegaprint_y, omegaprint_z;
...
void loop()
{
    ...
    if (IMU.gyroscopeAvailable())
    {
        ...
        omegaprint_x = omega_x + omega_x_bias;
        omegaprint_y = omega_y + omega_y_bias;
        omegaprint_z = omega_z + omega_z_bias;

        // Print the gyroscope measurements to the Serial Monitor
        Serial.print(omegaprint_x);
        Serial.print("\t");
        Serial.print(omegaprint_y);
        Serial.print("\t");
        Serial.print(omegaprint_z);
        Serial.print(" deg/s\n");
    }
}
